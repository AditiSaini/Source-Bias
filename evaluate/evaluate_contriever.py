...
print("The test dataset is {}".format(dataset))
print("The test target model is {}".format(target))
print("The candidate_lm is {}".format(candidate_lm))
print("The args is {}".format(args))
...
model = DRES(models.SentenceBERT("all-MiniLM-L6-v2"), batch_size=args.batch_size, corpus_chunk_size=args.batch_size*9999)
